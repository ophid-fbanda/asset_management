...
const dataKey = computed(() => (station.value != null ? `approvals/supervisory/history/${station.value}` : null))
...
const exportExcel = () => {
  exportToExcel(filteredRecords.value, 'supervisory-history', 'Approval History')
}
