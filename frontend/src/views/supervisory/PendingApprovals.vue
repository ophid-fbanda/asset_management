...
// Maps event_type from events_view to the FormRouter template id.
// Add new entries here as templates are created.
const TEMPLATE_MAP = {
...
const toggleCollect = (row) => {
  ...
  if (index === -1) {
    ...
    context.options = [{ id: templateId, name: row.event_type, table: 1, target: 0, choices: [40, 41] }]
